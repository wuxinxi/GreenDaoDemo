...
public class InfoDao extends AbstractDao<Info, Long> {
    ...
    public static class Properties {
        ...
        public final static Property AddRess = new Property(3, String.class, "addRess", false, "ADD_RESS");
        public final static Property Test = new Property(4, String.class, "test", false, "TEST");
    }
    ...
    public Info readEntity(Cursor cursor, int offset) {
        Info entity = new Info( //
            ...
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4) // test
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Info entity, int offset) {
        ...
        entity.setTest(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
     }
